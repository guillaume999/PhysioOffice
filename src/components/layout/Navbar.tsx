...
const navSections: NavSection[] = [
  {
    ...
    btnActiveClass: "bg-primary/20 text-primary",
    itemClass: "text-muted-foreground hover:bg-primary/10 hover:text-primary",
    itemActiveClass: "bg-primary/20 text-primary font-medium",
    items: [
  ...
  },
  {
    ...
    label: "Rééducation",
    icon: Stethoscope,
    btnClass: "bg-violet-500/10 text-violet-600 hover:bg-violet-500/20",
    btnActiveClass: "bg-violet-500/20 text-violet-600",
    itemClass: "text-muted-foreground hover:bg-violet-500/10 hover:text-violet-600",
    itemActiveClass: "bg-violet-500/20 text-violet-600 font-medium",
    items: [
  ...
  },
  {
    ...
    label: "Communauté",
    icon: Globe,
    btnClass: "bg-teal-500/10 text-teal-600 hover:bg-teal-500/20",
    btnActiveClass: "bg-teal-500/20 text-teal-600",
    itemClass: "text-muted-foreground hover:bg-teal-500/10 hover:text-teal-600",
    itemActiveClass: "bg-teal-500/20 text-teal-600 font-medium",
    items: [
